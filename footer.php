					...
					<div class="site-info">
						...
						<div class="row">
							<div class="col-sm-6 col-md-6 text-left clearfix">
								© <?php	echo date('Y') ?> Bright Country Golf Club
							</div>
							<div class="col-sm-6 col-md-6 text-right clearfix">
								<div class="footer-text">
									Back Porepunkah Road, Bright Victoria 3741<br>
									Phone: <a href="tel:0357551773">03 5755 1773</a> • 
									<a href="mailto: info@brightgolf.org.au">email us</a> 
									<a href="../wp-admin/">
										<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 416 512" style="width:24px; height:24px; margin-left: 10px;">
